...
from codeseam.semantic.task_graph import SemanticOperation, SemanticTask, SemanticTaskGraph
...
class MatlabSemanticRenderer:
    """First renderer plugin; semantic truth itself contains no MATLAB syntax."""

    language_id = "matlab"

    def render(
        self, graph: SemanticTaskGraph, *, seed: int = 0, style: str = "vectorized"
    ) -> RenderedMatlab:
        return render_matlab(graph, seed=seed, style=style)
